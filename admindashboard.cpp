...
AdminDashboard::AdminDashboard(Inventory* inv, QWidget* parent)
    : QWidget(parent),
...
//  Function pointer connect works with any regular private
//  function — no slots: section required
// ============================================================
...
// ============================================================
//  Private – shared row-fill (plain int loop, no Qt containers)
// ============================================================
...
// ============================================================
//  Private – sidebar active state (plain pointer array)
// ============================================================
